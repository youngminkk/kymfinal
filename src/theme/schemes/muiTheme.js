...
const colors = {
  ...
  shadows: {
    ...
    card: '0px 0px 2px #D6D6D6',
    cardSm: '0px 0px 2px #D6D6D6',
    cardLg:
...
export const muiTheme = createTheme({
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(alpha('#A3A3A3', 1), 0.4),
    ...
    MuiSwitch: {
      styleOverrides: {
        ...
        thumb: {
          border: `1px solid ${colors.alpha.black[30]}`,
          boxShadow: `0px 9px 14px ${colors.alpha.black[100]}, 0px 2px 2px ${colors.alpha.black[100]}`
        },
        track: {
          backgroundColor: colors.alpha.black[5],
